...
(
	set -x
	debootstrap --no-check-gpg --arch=armhf --verbose --variant='minbase' --include='apt-utils,iproute,iputils-ping,locales,vim' wheezy "$rootfsDir" "http://mirrors.aliyun.com/raspbian/raspbian/ wheezy main contrib non-free rpi"
)
